...
| Type | Name |
| ---: | :--- |
|   | [**Uploader**](#function-uploader-13) (std::unique\_ptr&lt; InputPacketCommunicator &gt; input, std::unique\_ptr&lt; OutputPacketCommunicator &gt; output, [**TimeoutLock**](classjac_1_1TimeoutLock.md) & lock, std::filesystem::path rootDir, std::function&lt; void(std::filesystem::path)&gt; formatFS) <br> |
